...
input_file = "../1_index_day/Labeled_EarningsSearches.xlsx"  # Replace with the actual file name
...
output_file = "labeled_earningsearch_with_surprise_and_price.xlsx"
