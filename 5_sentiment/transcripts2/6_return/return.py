...
file_path = "../5_control/labeled_earningsearch_with_log_market_cap_nearby_dates.xlsx"
...
for index, row in data.iterrows():
    ...
    date_before = get_trading_dates(db, date, 1, direction="backward")
    date_after = get_trading_dates(db, date, 1, direction="forward")
    date_2_days_after = get_trading_dates(db, date, 2, direction="forward")
    date_75_days_after = get_trading_dates(db, date, 75, direction="forward")
